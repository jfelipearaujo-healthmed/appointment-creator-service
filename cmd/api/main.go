...
import (
	...
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/core/infrastructure/shared/logger"
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/external/http/server"
...
func main() {
	...
	go func(ctx context.Context, wg *sync.WaitGroup) {
		...
		for {
			server.AppointmentQueueService.ConsumeMessages(ctx)
