...
import (
	...
	event_processor_uc "github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/core/application/use_cases/event/event_processor"
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/core/infrastructure/config"
	appointment_repository "github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/core/infrastructure/repository/appointment"
	event_repository "github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/core/infrastructure/repository/event"
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/external/http/handlers/health"
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/external/http/handlers/middlewares/logger"
	...
	"github.com/jfelipearaujo-healthmed/appointment-creator-service/internal/external/secret"
...
func NewServer(ctx context.Context, config *config.Config) (*Server, error) {
	...
	eventProcessor := event_processor_uc.NewUseCase(eventRepository, appointmentRepository)

	appointmentQueue := queue.NewService(config.CloudConfig.AppointmentQueueName, cloudConfig, eventProcessor.Handle)

	if err := appointmentQueue.UpdateQueueUrl(ctx); err != nil {
	...
	return &Server{
		...
		Dependencies: Dependencies{
			...
			AppointmentQueueService: appointmentQueue,
		},
	}, nil
}
